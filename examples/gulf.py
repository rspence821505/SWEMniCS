...
if __name__ == "__main__":
    ...
    # supg
    solver = get_solver(args.solver)(prob, theta, p_degree=p_degree)
    if args.solver == "supg":
        params["max_it"] = 20
    ...
    if rank == 0:
        ...
        if args.stations is not None:
            ...
            s_inds = station_index[
                np.floor((inds % station_data[0].size) / 3).astype(int)[::3]
            ]
