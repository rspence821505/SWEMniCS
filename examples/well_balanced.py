from swemnics.forward.problems import WellBalancedProblem
...
prob = WellBalancedProblem(
    dt=dt, nt=nt, friction_law=fric_law, solution_var=sol_var, spherical=False
)
p_degree = [1, 1]
rel_toleran = 1e-9
abs_toleran = 1e-10
