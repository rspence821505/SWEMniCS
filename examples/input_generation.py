...
<<<<<<< HEAD:examples/sloped_beach_test.py
=======
...
>>>>>>> df589aa (updated bayes da):examples/input_generation.py
comm = MPI.COMM_WORLD
rank = comm.Get_rank()
...
true_signal, prob, stations, state_coords = get_true_signal(
    problem_params, "sloped_beach", solver_params, 2
)
...
if rank == 0:
    da_inputs = {
        ...
        "true_states": true_signal.saved_states,
        "state_dim": state_dim,
        "obs_dim": obs_dim,
        "H": H,
        "R_inv": R_inv,
...
>>>>>>> df589aa (updated bayes da):examples/input_generation.py
    ...
    with open("da_inputs.pkl", "wb") as f:
        pickle.dump(da_inputs, f)
...
=======
    # print da_inputs dictionary
    for key, value in da_inputs.items():
