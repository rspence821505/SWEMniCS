#!/usr/bin/env python3
"""
Dam break case: Parallel 4D-Var data assimilation experiment.
...
Run with:
    mpirun -n 4 python dam_break_4dvar_mpi.py
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Parallel Dam break 4D-Var data assimilation experiment",
...
def main():
    """Run parallel dam break 4D-Var experiment."""
    args = parse_args()
    ...
    if rank == 0:
        print("=" * 70)
        print("Parallel Dam Break 4D-Var Data Assimilation Experiment")
        print("=" * 70)
    ...
    if rank == 0:
        print("\n" + "=" * 70)
        print("SUMMARY: Parallel Dam Break 4D-Var Experiment")
        print("=" * 70)
        print(f"MPI ranks:         {size}")
