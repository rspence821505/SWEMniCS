#!/usr/bin/env python3
"""
Dam break case: Standard 4D-Var data assimilation experiment.
...
5. Minimize 4D-Var cost function using L-BFGS

Usage:
    python dam_break_4dvar.py [--nx 30] [--ny 30] [--dt 0.5] [--final-time 20]
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Dam break 4D-Var data assimilation experiment",
...
def main():
    """Run dam break 4D-Var experiment."""
    args = parse_args()
    comm = MPI.COMM_WORLD
    rank = comm.Get_rank()
    ...
    if rank == 0:
        print("=" * 70)
        print("Dam Break 4D-Var Data Assimilation Experiment")
        print("=" * 70)
    ...
    if rank == 0:
        print("\n" + "=" * 70)
        print("SUMMARY: Dam Break 4D-Var Experiment")
        print("=" * 70)
